...
# Runs ESLint auto-fix and then ESLint check for edited source files
# (.ts/.tsx/.js/.jsx) under the src/ directory.
#
# Outputs nothing (exits 0 silently) for non-source files.
